...
Mongoose.prototype.JsonSchema = JsonSchema;

/**
 * The Mongoose [JsonSchema](#jsonschema_JsonSchema) constructor
 *
 * ####Example:
 *
 *     var mongoose = require('mongoose');
 *     var JsonSchema = mongoose.JsonSchema;
 *     var CatSchema = new JsonSchema('your/path/Json-Schema.json');
 *
 * @method Schema
 * @api public
 */
